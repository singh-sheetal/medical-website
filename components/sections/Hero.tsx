    ...
    >
      ...
      <div
        ...
        style={{
          position: "absolute",
          inset: 0,
          backgroundImage: `radial-gradient(circle at 20% 50%, rgba(61,90,158,0.05) 0%, transparent 50%),
            radial-gradient(circle at 80% 20%, rgba(232,145,106,0.06) 0%, transparent 40%)`,
          pointerEvents: "none",
        }}
      />
        ...
        <div style={{ maxWidth: "540px" }}>
          ...
          >
            ...
            >
              ...
              >
                <path
                  d="M2 8 C60 2, 140 10, 200 5 C240 2, 270 8, 298 4"
          ...
          >
            Spend less time on paperwork and more time with patients. MedicalOS
            handles documentation, scheduling, billing, and patient
